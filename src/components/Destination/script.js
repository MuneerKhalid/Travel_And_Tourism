document.addEventListener("DOMContentLoaded", () => {
  const destinations = [
    ...
    {
      headText: "Arctic Wonders: Exploring Kittilä's Frozen Beauty",
      rating: "4.6 ·",
      review: "162 reviews ",
      location: "Kittila, Finland",
      imgLeft: "../../../assets/finland2.jpg",
      imgRightTop: "../../../assets/finland3.avif",
      imgRightBottom: "../../../assets/finland1.webp",
      detailsSub1: "6 persons ·",
      detailsSub2: "Freezy ·",
      detailsSub3: "3 bed ·",
      detailsSub4: "2 bath",
      price: "8.3k Tax included",
      description: "Discover the enchanting allure of Kittilä, Finland. Immerse yourself in a winter wonderland where snow-laden landscapes stretch as far as the eye can see. From exhilarating husky sledding to witnessing the mesmerizing Northern Lights, Kittilä offers an unforgettable Arctic escape filled with cozy cabins, rich Sami culture, and nature's dazzling spectacle...",
      view: "Arctic view",
      wifi: "Wifi",
      parking: "Rendeers",
      TV: " Premium cable",
      ...
      DW: "Indoor workspace",
      pool: "Heated pool - available all year",
      elevator: "Cable cart",
    },
    {
      headText: "Safari wonders and coastal bliss in South Africa.",
      rating: "4.4 ·",
      review: "133 reviews ",
      location: "Tulbagh, South Africa",
      imgLeft: "../../../assets/southafrica1.webp",
      imgRightTop: "../../../assets/southafrica3.webp",
      imgRightBottom: "../../../assets/southafrica2.jpg",
      detailsSub1: "5 persons ·",
      detailsSub2: "Nature ·",
      detailsSub3: "2 bed ·",
      detailsSub4: "2 bath",
      price: "3.9k Tax included",
      description: "Embark on a journey to Tulbagh, South Africa, where picturesque landscapes and rich history await. Nestled in the Cape Winelands, this charming town captivates with its stunning vineyards and Cape Dutch architecture. Explore the surrounding mountains, savor exquisite wines, and immerse yourself in the tranquility of this hidden gem...",
      view: "Safaric view",
      wifi: "Wifi",
      parking: "Free cattles on premises",
      TV: " Premium cable, Netflix",
      kitchen: "Outdoor Kitchen",
      DW: "Indoor workspace",
      pool: "No pool",
      elevator: "Jeeps",
    },
    {
      ...
      imgLeft: "../../../assets/indonesia1.webp",
      imgRightTop: "../../../assets/indonesia22.webp",
      imgRightBottom: "../../../assets/indonesia3.webp",
      detailsSub1: "12 persons ·",
      detailsSub2: "Luxury ·",
      detailsSub3: "4 bed ·",
      detailsSub4: "3 bath",
      price: "18k Tax included",
      description: "Embark on a journey to the captivating landscapes of Sidemen, Indonesia. Nestled amidst terraced rice paddies and lush valleys, Sidemen offers a serene escape from the bustle of modern life. Immerse yourself in traditional Balinese culture, explore vibrant markets, and rejuvenate your senses with breathtaking views of Mount Agung. Uncover the hidden gem of Indonesia as you discover the tranquility and charm that Sidemen has to offer...",
